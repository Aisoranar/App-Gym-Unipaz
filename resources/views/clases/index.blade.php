...
<div class="animated-bg header-index">
  ...
  <a href="{{ route('clases.create') }}" class="btn btn-custom mt-3">
    ...
    @foreach($clases as $clase)
      <div class="card-item">
        ...
        <div class="card-actions">
          <a href="{{ route('clases.show', $clase) }}" class="btn btn-custom btn-sm" title="Ver">
            <i class="fa-solid fa-eye"></i> Ver
          </a>
          <a href="{{ route('clases.edit', $clase) }}" class="btn btn-custom btn-sm" title="Editar">
