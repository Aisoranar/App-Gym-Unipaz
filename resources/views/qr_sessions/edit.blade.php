...
<div class="container-fluid animated-bg">
  <div class="container header-edit text-center">
    <h1>Editar Sesión QR</h1>
  </div>
</div>
  ...
  <div class="form-card">
    <form action="{{ route('qr-sessions.update', $session->id) }}" method="POST">
      ...
      <div class="form-check mb-4">
        ...
        <input class="form-check-input" type="checkbox" name="activo" id="activo" value="1" {{ old('activo', $session->activo) ? 'checked' : '' }}>
